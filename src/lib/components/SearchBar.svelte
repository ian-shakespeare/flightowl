...
<div class='grid gap-4 w-full py-6 border-2 border-gray-100 justify-center items-center shadow-lg rounded-lg lg:grid-flow-col lg:gap-2 lg:w-min lg:py-3 lg:pl-8 lg:pr-4 lg:rounded-full'>
